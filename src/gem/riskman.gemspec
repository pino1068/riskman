...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "bin/riskman", "lib/riskman.rb", "lib/riskman.jar", "lib/hamcrest-all-1.1.jar", "test/test_riskman.rb", "test/test_helper.rb"]
  ...
  s.test_files = ["test/test_riskman.rb", "test/test_helper.rb"]
