...
public class LoadCommandTest {
	...
	public void shouldLoadPortfolioCsv() {
		...
		new LoadCommand("src/test/resources/portfolio1.csv").execute(System.getProperty("user.dir"), positions);
	...
	public void shouldLoadPortfolioCsvWithComments() {
		Positions positions = new Positions();
		String output = new LoadCommand("src/test/resources/portfolio-with-unknown-position.csv").execute(System.getProperty("user.dir"), positions);
		assertThat(output, containsString(" KO"));
