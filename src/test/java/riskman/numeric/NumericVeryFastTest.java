...
import static riskman.numeric.VeryFastNumeric.*;
...
import riskman.numeric.VeryFastNumeric;

public class NumericVeryFastTest {
	...
	public void shouldInvertAndDivide4By3() {
		...
		assertThat(_(4.0 / 3.0), is(_(4).divide(_(3))));
		assertThat(_(4.0 / 3.0), is(_(3.0 / 4.0).invert()));
	}

	@Test
	public void shouldScaleALotWithDoubles() {
		int scale = 17;

		VeryFastNumeric a = _(4.0 / 3.0).scaleTo(scale);
		VeryFastNumeric b = _(4).divide(_(3)).scaleTo(scale);
	...
	public void shouldNotIfNotScaled() {
		VeryFastNumeric scaledTo7 = _(0.00000000001).scaleTo(7);
		
		assertThat(_(0.00000001).scaleTo(7), is(scaledTo7));
