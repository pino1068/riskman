...
import static riskman.numeric.FastNumeric.*;
...
import riskman.numeric.FastNumeric;

public class NumericFastTest {
	...
	public void shouldUseToString() {
		assertEquals("2.0/1.0=2.0", _(2.000).toString());
	...
	public void shouldScaleALotWithDoubles() {
		...
		FastNumeric a = _(4.0 / 3.0).scaleTo(scale);
		FastNumeric b = _(4).divide(_(3)).scaleTo(scale);
	...
	public void shouldNotIfNotScaled() {
		FastNumeric scaledTo7 = _(0.00000000001).scaleTo(7);
